                ...
                new FirebaseRecyclerOptions.Builder<Conv>()
                        .setQuery(conversationQuery, new SnapshotParser<Conv>() {
                            ...
                            public Conv parseSnapshot(@NonNull DataSnapshot snapshot) {
                                return new Conv((boolean)snapshot.child("seen").getValue(),
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        holder.mView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                DatabaseReference mConvDatabase1 = FirebaseDatabase.getInstance().getReference().child("Chat").child(mCurrent_user_id);
                                mConvDatabase1.child(list_user_id).child("seen").setValue(true);
                                Intent chatIntent = new Intent(getContext(), ChatActivty.class);
                                chatIntent.putExtra("user_id", list_user_id);
                                chatIntent.putExtra("user_name", userName);
                                chatIntent.putExtra("seen", true);
